  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        accent: 'var(--accent)',
        accent50: 'var(--accent-rgb)',
        accentFont: 'var(--accentFont)',
        logoBg: 'var(--logoBg)',
      ...
      boxShadow: {
        ...
        custom: '4px 4px 15px 1px rgba(0, 0, 0, 0.15)',
        bottomblue: '0 4px 6px -1px rgba(1, 170, 193, 1), 0 2px 4px -1px rgba(1, 170, 193, 1)',
        card: '0px 1px 3px rgba(0, 0, 0, 0.12)',
        'card-2': '0px 1px 2px rgba(0, 0, 0, 0.05)',
        'card-3': '0px -1px 2px rgba(0, 0, 0, 0.15)',
        switcher:
